...
<div class="pull-right" ng-controller="columnFilterController">
  <div class="dropdown layout-inline"
    ...
    <a href=""
       id="<c:out value='${columnDataCell.field.name}'/>Filter"
          ...
          <div class="col-sm-6">
            <div class="checkbox">
              <label><input class="checkbox mright-5" type="checkbox"
                            ...
                            ng-model-options="{updateOn: 'blur'}" value="false"/>Not
                Blank</label>
            </div>
          </div>
        </div>
          ...
          <c:when test="${columnDataCell.field.inputType == 'Text'}">
            <div class="row mbottom-5">
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0" for="<c:out value='${columnDataCell.field.name}'/>Contains">Contains</label>
                  <input
                      id="<c:out value='${columnDataCell.field.name}'/>Contains" class="form-control" type="text"
              ...
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0"
                         for="<c:out value='${columnDataCell.field.name}'/>DoesNotContain">Does Not
                    Contain</label> <input id="<c:out value='${columnDataCell.field.name}'/>DoesNotContain"
            ...
            <div class="row mbottom-5">
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0"
                         for="<c:out value='${columnDataCell.field.name}'/>StartsWith">Starts With</label> <input
                    id="<c:out value='${columnDataCell.field.name}'/>StartsWith" class="form-control" type="text"
            ...
            <div class="row mbottom-5">
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0" for="<c:out value='${columnDataCell.field.name}'/>EndsWith">Ends
                    With</label> <input
                    id="<c:out value='${columnDataCell.field.name}'/>EndsWith" class="form-control" type="text"
          ...
          <c:when
            ...
            <div class="row mbottom-5">
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0"
                         for="<c:out value='${columnDataCell.field.name}'/>FromNumber">From</label> <input
                    id="<c:out value='${columnDataCell.field.name}'/>FromNumber" class="form-control text-right"
                    type="number"
            ...
            <div class="row mbottom-5">
              <div class="col-sm-12">
                <div class="input-group input-group-sm">
                  <label class="text-info small mbottom-0" for="<c:out value='${columnDataCell.field.name}'/>ToNumber">To</label>
                  <input
                      id="<c:out value='${columnDataCell.field.name}'/>ToNumber" class="form-control text-right"
                      type="number"
        ...
        <div class="row mtop-5">
          ...
          <div class="col-sm-6">
            <button class="btn btn-sm btn-default pull-right" type="button"
                    ng-click="restoreColumnFilter()">Cancel
            </button>
          </div>
        </div>
      </form>
